/*******************************************
29_2 Copy only prime number.cpp 

Write a program to fill arry with max size 100 
with rundom numbers from 1 to 100.copy only prime number to 
